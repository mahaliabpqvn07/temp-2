...
get_current_block_self() {
    ...
    while [ $retry_count -lt $max_retries ]; do
        currentblock=$(curl -s -X POST http://160.34.211.233:22825/api/1.0 \
...
#if [[ $cpu_cores -eq 48 && $totalThreads -gt 10 ]]; then
#    docker rm -f uam_13 uam_14 uam_12 uam_11
#    totalThreads=10
#fi
